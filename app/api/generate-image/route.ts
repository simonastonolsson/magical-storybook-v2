...
const STYLE_PROMPTS: Record<string, { positive: string; negative: string; qualityBoost: string; loraScale: number; loraScaleChild: number }> = {
  digital_painting: {
