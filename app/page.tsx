    ...
    <>
      ...
      <section className="testimonials">
        ...
        <div className="testimonial-grid">
          ...
          <div className="testimonial"><div className="stars">★★★★★</div><p>Perfekt 40-årspresent till min bästa vän. Hon grät av lycka när hon såg sig själv som hjältinna i ett rymdsäventyr. Kommer beställa fler!</p><div className="testimonial-author"><div className="avatar" style={{background:'#fce7f3'}}>👱‍♀️</div><div><div className="author-name">Sara M.</div><div className="author-role">Köpte som present</div></div></div></div>
        </div>
      </section>
